...
export default function CoinCard({
  ...
  return (
    <li className="bg-white dark:bg-black shadow-md rounded-md max-w-full hover:cursor-default overflow-x-auto p-4 flex flex-col sm:flex-row flex-nowrap items-center gap-2 hover:-translate-y-1 duration-200">
      <CoinCardTitle coin={coin} position={position} />
      <CoinCardInfoFields coin={coin} />
      <CoinCardButtons coinId={coin.id} isFavorite={true} />
    </li>
  )
}
